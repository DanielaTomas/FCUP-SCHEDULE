...
\item The period of an event is assigned based on: 
	...
	\begin{equation}
	n \mod AP
	\end{equation}\label{period_allocation}

\item The room of an event is assigned based on:
	\begin{equation}
	\frac{n}{AP} \mod AR
	\end{equation}\label{room_allocation}
\end{itemize}
