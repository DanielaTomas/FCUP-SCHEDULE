...
Metaheuristics, while not guaranteeing global optimality, have become the most used solution strategy for \ac{ucttp} and can be classified into two categories: Single solution-based and Population-based.
...
In particular, Tomáš Müller, winner of the \ac{itc-2007} tracks 1 and 3, developed a hybrid approach\footnote{https://github.com/tomas-muller/cpsolver-itc2007} for all three tracks \cite{muller_itc2007}, finding feasible solutions for all instances of tracks 1 and 3 and most instances of track 2. 
